...
exports.seed = async function (knex) {
  ...
  await knex('books').insert([
    { id: 1, title: 'IT', pages: 1168, ISBN: '1501182099', published_date: 'September 15, 1986', genre_id: 1, publisher_id: 1, author_id: 1, format_id: 1, synopsis_id: 1, cover_image: 'https://lareviewofbooks.org/article/where-it-was-rereading-stephen-kings-it-on-its-30th-anniversary/' },
    { id: 2, title: 'Grapes of Wrath', pages: 464, ISBN: '0143039431', published_date: 'April 14, 1939', genre_id: 2, publisher_id: 2, author_id: 2, format_id: 2, synopsis_id: 2, cover_image: 'https://en.wikipedia.org/wiki/The_Grapes_of_Wrath' },
    { id: 3, title: 'Dracula', pages: 756, ISBN: '1435159578', published_date: 'May 26, 1897', genre_id: 1, publisher_id: 3, author_id: 3, format_id: 5, synopsis_id: 6, cover_image: 'https://www.pinterest.ie/BramStokerDub/bram-stokers-dracula-book-cover-designs/' },
    ...
    { id: 5, title: 'Alice\'s Adventures in Wonderland', pages: 52, ISBN: '9780582534148', published_date: 'June 1865', genre_id: 12, publisher_id: 5, author_id: 5, format_id: 2, synopsis_id: 3, cover_image: 'https://www.budplantandhutchisonbooks.com/pages/books/29222/lewis-carroll/alices-adventures-in-wonderland' },
